<?php
$pageTitle = 'Leads | Add New Lead';
$menuItem1 = 'leads';
$menuItem2 = 'add-new-lead';
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="customer_first_name" name="customer_first_name" placeholder="First name" value="" required="">
                            </div>

                            <div class="mb-3">
                                <label for="customer_last_name" class="form-label">Last name</label>
                                <input type="text" class="form-control" id="customer_last_name" name="customer_last_name" placeholder="Last name" value="" required="">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="customer_tel_mobile" name="customer_tel_mobile" placeholder="Telephone" value="" required="">
                            </div>

                            <div class="mb-3">
                                <label for="customer_email" class="form-label">Email</label>
                                <input type="email" class="form-control" id="customer_email" name="customer_email" placeholder="Email" value="" required="">
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="customer_address1" name="customer_address1" placeholder="Address 1" value="" required="">
                            </div>

                            <div class="mb-3">
                                <label for="customer_address2" class="form-label">Address 2</label>
                                <input type="text" class="form-control" id="customer_address2" name="customer_address2" placeholder="Address 2" value="">
                            </div>

                            <div class="mb-3">
                                <label for="customer_city" class="form-label">Town</label>
                                <input type="text" class="form-control" id="customer_city" name="customer_city" placeholder="Town" value="" required="">
                            </div>

                            <div class="mb-3">
                                <label for="customer_county" class="form-label">County/State</label>
                                <input type="text" class="form-control" id="customer_county" name="customer_county" placeholder="County/State" value="" required="">
                            </div>

                            <div class="mb-3">
                                <label for="customer_postcode" class="form-label">Post/Zip Code</label>
                                <input type="text" class="form-control" id="customer_postcode" name="customer_postcode" placeholder="Post/Zip Code" value="" required="">
                            </div>
